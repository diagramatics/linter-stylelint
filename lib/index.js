...
export function activate() {
  ...
  atom.config.observe('linter-stylelint.usePreset', value => usePreset = value);
  atom.config.observe('linter-stylelint.presetConfig', value => presetConfig = require(value));
  atom.config.observe('linter-stylelint.disableWhenNoConfig', value => disableWhenNoConfig = value);
}
...
export function provideLinter() {
  return {
    name: 'stylelint',
    grammarScopes: ['source.css', 'source.scss', 'source.css.scss', 'source.css.less'],
    scope: 'file',
    lintOnFly: true,
    lint: (editor) => {
